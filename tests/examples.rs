...
test_should_request_be_blocked! {
    (   name: pre_request_wild_connect_port_allow,
        ...
        dest: None,
        result: Allowed),
    (   name: pre_request_wild_connect_port_allow_normalization_url,
        url: "https://www.notriddle.com:0443/meta",
        origin: "https://example.com",
        policy: "connect-src https://*.notriddle.com:443",
        dest: None,
        result: Allowed),
    (   name: pre_request_wild_connect_port_allow_normalization_policy,
        url: "https://www.notriddle.com:443/meta",
        origin: "https://example.com",
